         ...
         {readmore && (
                <div className="">
                  <h2 className="text-xl underline  font-semibold space-y-5 my-3 ">  Our  Financing Policy:</h2>
                    ...
                    As a private individual, you can have your car financed by {" "} <i className="font-bold">Autoshop</i>. 
                    We will always make a suitable proposal that fits your personal situation. Because it concerns private financing, extras such as road tax, maintenance, and insurance are not included in this credit form. 
                    {" "}<i className="font-bold">However</i>, you will become the owner of the car when your loan has been paid off.
                  ...
                  <h2 className="text-xl underline  font-semibold space-y-5 my-3 ">How does it work?</h2>
                    ...
                    &quot;Pay half now and the other half within the chosen monthly
                    term.&quot;
                </div>
            )}
